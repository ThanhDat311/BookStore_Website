...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Delete additional images if selected
...
<div class="container mt-5">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="images">Upload New Additional Images (multiple allowed)</label>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="descriptions" name="descriptions"
                rows="3"><?= htmlspecialchars($product['descriptions']) ?></textarea>
        </div>
